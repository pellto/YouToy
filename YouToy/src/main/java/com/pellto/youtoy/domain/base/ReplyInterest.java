...
@MappedSuperclass
@NoArgsConstructor
public abstract class ReplyInterest<RC> extends
    Interest {
  ...
  public ReplyInterest(RC interestedReply, UserUUID interestingUserUuid,
      Long id, boolean dislike, LocalDateTime createdAt) {
    super(dislike, createdAt);
    this.id = id;
    this.interestedReply = Objects.requireNonNull(interestedReply);
