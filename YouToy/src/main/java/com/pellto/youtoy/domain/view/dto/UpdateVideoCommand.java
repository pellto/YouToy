...
public class UpdateVideoCommand extends AbVideoCommand {
  ...
  public UpdateVideoCommand(@NotNull Long channelId, @NotNull Long userId, String title,
      String description) {
  ...
  public UpdateVideoCommand(@NotNull Long id, @NotNull Long channelId, @NotNull Long userId,
